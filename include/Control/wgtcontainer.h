#ifndef WGTWgtContainer_H
#define WGTWgtContainer_H
...
template <typename T>
class CSUTILS_EXPORT WgtContainer : public CSWidget
{
public:
    WgtContainer(QWidget *parent = nullptr);
    virtual ~WgtContainer();
