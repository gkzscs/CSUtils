...
void CSHBoxLayout::refreshByOuterWidget(QWidget *s, QResizeEvent *e)
{
...
void CSHBoxLayout::refreshByInnerWidgets(QWidget *s, QResizeEvent *e)
{
    if (!s || !_listItems.contains(s) || e->oldSize().width() == e->size().width()) return;
