...
void QtMaterialStylePrivate::init()
{
    ...
    QFontDatabase::addApplicationFont(":/fonts/Roboto/Roboto-Regular");
    QFontDatabase::addApplicationFont(":/fonts/Roboto/Roboto-Medium");
    QFontDatabase::addApplicationFont(":/fonts/Roboto/Roboto-Bold");
